/*
  ...
  - Added the required column `document` to the `Business` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `Business` ADD COLUMN `document` VARCHAR(191) NOT NULL,
