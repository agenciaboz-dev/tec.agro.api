/*
  ...
  - Made the column `rating` on table `Crop` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `Crop` MODIFY `rating` DOUBLE NOT NULL DEFAULT 5,
