/*
  ...
  - You are about to drop the column `user_id` on the `Business` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX `Business_user_id_key` ON `Business`;
...
-- AlterTable
ALTER TABLE `Business` DROP COLUMN `user_id`,
